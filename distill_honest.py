...
def main(args):
    ...
    if args.dataset == 'CIFAR10':
        if args.model == 'ConvNet':
            ...
            save_path = os.path.join(args.syn_image_save_path, "honest_cifar10_ConvNet_syn")
    ...
    wandb.init(sync_tensorboard=False,
               ...
               job_type="CleanRepo",
               name="honest ipc={0} model={1} dataset={2}".format(args.ipc,args.model,args.dataset),
               config=args,
               )
    ...
    if not os.path.exists(txt_dir):
        os.makedirs(txt_dir)
    acc_file_name = "distill_acc_honest_"+str(args.model)+"_"+str(args.dataset)+"_"+str(args.ipc)+".txt"
    ...
    e_txt.write("{0}    {1}    {2}    {3}    honest distill time".format(execution_time,args.model,args.dataset,args.ipc)+"\n")
    e_txt.close()

    if args.dataset == 'CIFAR10':
        file_name_acc = "acc_cifar10.txt"
        acc_txt = open(txt_dir+file_name_acc, 'a')
        acc_txt.write("{0}    {1}    {2}    {3}    honest".format(max_acc,args.model,args.dataset,args.ipc)+"\n")
        acc_txt.close()
    elif args.dataset == 'CIFAR100':
