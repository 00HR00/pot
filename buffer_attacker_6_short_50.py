...
def main(args):
    ...
    wandb.init(sync_tensorboard=False,
               ...
               job_type="Train",
               name="attacker6 short_len50 target_Mn={0}  alpha={1} model={2} dataset={3}".format(149, args.alpha_para,args.model, args.dataset),
               config=args,
               )
    ...
    if args.dataset == 'CIFAR10':
        if args.model == 'ConvNet':
            ...
            teacher_net_save_path = os.path.join(args.intermediate_result_save_path, "attacker_66_cifar10_ConvNet_t")
            buffer_s_data_dir = os.path.join(args.intermediate_result_save_path, "attacker_66_cifar10_ConvNet_b")
            ...
            teacher_net_save_path = os.path.join(args.intermediate_result_save_path, "attacker_66_cifar10_ConvNetD2_t")
            buffer_s_data_dir = os.path.join(args.intermediate_result_save_path, "attacker_66_cifar10_ConvNetD2_b")
            if not os.path.exists(teacher_net_save_path):
                os.makedirs(teacher_net_save_path)
            if not os.path.exists(buffer_s_data_dir):
                os.makedirs(buffer_s_data_dir)
            ...
            teacher_net_save_path = os.path.join(args.intermediate_result_save_path, "attacker_66_cifar10_ConvNetD4_t")
            buffer_s_data_dir = os.path.join(args.intermediate_result_save_path, "attacker_66_cifar10_ConvNetD4_b")
            if not os.path.exists(teacher_net_save_path):
                os.makedirs(teacher_net_save_path)
            if not os.path.exists(buffer_s_data_dir):
                os.makedirs(buffer_s_data_dir)
            ...
            teacher_net_save_path = os.path.join(args.intermediate_result_save_path, "attacker_66_cifar10_ResNet18_t")
            buffer_s_data_dir = os.path.join(args.intermediate_result_save_path, "attacker_66_cifar10_ResNet18_b")
            if not os.path.exists(teacher_net_save_path):
                os.makedirs(teacher_net_save_path)
            if not os.path.exists(buffer_s_data_dir):
                os.makedirs(buffer_s_data_dir)
            ...
            teacher_net_save_path = os.path.join(args.intermediate_result_save_path, "attacker_66_cifar10_ResNet34_t")
            buffer_s_data_dir = os.path.join(args.intermediate_result_save_path, "attacker_66_cifar10_ResNet34_b")
            if not os.path.exists(teacher_net_save_path):
                os.makedirs(teacher_net_save_path)
            if not os.path.exists(buffer_s_data_dir):
                os.makedirs(buffer_s_data_dir)
        ...
        if args.model == 'ConvNet':
            ...
            teacher_net_save_path = os.path.join(args.intermediate_result_save_path, "attacker_66_cifar100_ConvNet_t")
            buffer_s_data_dir = os.path.join(args.intermediate_result_save_path, "attacker_66_cifar100_ConvNet_b")
            if not os.path.exists(teacher_net_save_path):
                os.makedirs(teacher_net_save_path)
            if not os.path.exists(buffer_s_data_dir):
                os.makedirs(buffer_s_data_dir)
            ...
            teacher_net_save_path = os.path.join(args.intermediate_result_save_path, "attacker_66_cifar100_ConvNetD2_t")
            buffer_s_data_dir = os.path.join(args.intermediate_result_save_path, "attacker_66_cifar100_ConvNetD2_b")
            if not os.path.exists(teacher_net_save_path):
                os.makedirs(teacher_net_save_path)
            if not os.path.exists(buffer_s_data_dir):
                os.makedirs(buffer_s_data_dir)
            ...
            teacher_net_save_path = os.path.join(args.intermediate_result_save_path, "attacker_66_cifar100_ConvNetD4_t")
            buffer_s_data_dir = os.path.join(args.intermediate_result_save_path, "attacker_66_cifar100_ConvNetD4_b")
            if not os.path.exists(teacher_net_save_path):
                os.makedirs(teacher_net_save_path)
            if not os.path.exists(buffer_s_data_dir):
                os.makedirs(buffer_s_data_dir)
            ...
            teacher_net_save_path = os.path.join(args.intermediate_result_save_path, "attacker_66_cifar100_ResNet18_t")
            buffer_s_data_dir = os.path.join(args.intermediate_result_save_path, "attacker_66_cifar100_ResNet18_b")
            if not os.path.exists(teacher_net_save_path):
                os.makedirs(teacher_net_save_path)
            if not os.path.exists(buffer_s_data_dir):
                os.makedirs(buffer_s_data_dir)
            ...
            teacher_net_save_path = os.path.join(args.intermediate_result_save_path, "attacker_66_cifar100_ResNet34_t")
            buffer_s_data_dir = os.path.join(args.intermediate_result_save_path, "attacker_66_cifar100_ResNet34_b")
            if not os.path.exists(teacher_net_save_path):
                os.makedirs(teacher_net_save_path)
            if not os.path.exists(buffer_s_data_dir):
                os.makedirs(buffer_s_data_dir)
    ...
    e_txt.write("attacker 6 short time:{0}s    {1}    {2}".format(execution_time,args.model,args.dataset)+"\n")
    e_txt.close()
